...
import InternalAdministration from "./layout";

export const metadata: Metadata = {
  title: "Internal Administration | DotWebsHosting",
  description:
...
export default function InternalAdministrationPage(){
    return(
        <>
        <InternalAdministration></InternalAdministration>
        </>
    )
}